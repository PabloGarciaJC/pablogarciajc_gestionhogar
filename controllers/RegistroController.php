...
class RegistroController
{
    ...
    if (isset($_POST)) {
      ...
      if (count($errores) == 0) {
        ...
        if ($edit) {
          ...
          $_SESSION["mensajeTablaError"] = "<strong> Hubo un Problema, </strong> de <strong>EDICIÓN</strong> verifique los Campos !!!";
          $_SESSION["form"] = $form;
          header("Location:" . base_url . 'Registro/index');
        }
      } else {
  ...
  public function historial()
  {
    if (isset($_GET['id'])) {
      ...
      $RegistroTodo = $registro->getAllRegister(); 
      $RegistrosTodos = $RegistroTodo->fetch_object();    
  ...
  public function bannerTwoRegistro()
  {
    if (isset($_POST)) {
      ...
      if (count($errores) == 0) {
        ...
        if($edit){         
          $_SESSION["bannerTwo"] = "Tabla <strong>Los Ingresos</strong> se ha <strong>EDITADO</strong> con EXITO";
        }
      } 
    }
    header("Location:" . base_url . 'Registro/historial&id=' . $id);
  }
}
