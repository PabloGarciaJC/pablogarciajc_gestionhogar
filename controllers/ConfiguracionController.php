...
class ConfiguracionController
{
    ...
    public function buscador()
    {
        ...
        htmlConfiguracion::obtenerTodos($imputBuscador, $paginaActual, $obtenerIdRegistro, $repoblar);
    }
    ...
    {
        $idRepoblar = isset($_POST["repoblar"]) ? $_POST["repoblar"] : false;
        $configuracion = new Configuracion();
        $configuracion->setIdRegistro($idRepoblar);
        $configuracion->repoblarTabla();
